//when string question two question ask if equal to kya karna and unequal to kya karna
//equal  i+1,j-1
//unequal  i+1,j
  //         i,j-1
  //always start form n-1,m-1 so that easy to find base case
  //alway dp fill with -1
